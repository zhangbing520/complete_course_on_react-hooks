...
exports.default = {
    ...
    ERROR_META_SHOULD_FETCH_FIRST: '本地的物料信息已经落后于远端，请执行 arco sync --fetch 以更新至最新',
    ERROR_GET_PACKAGE_INFO_FAILED: '获取 NPM 包信息失败',
    ERROR_NEED_PUPPETEER: '自动截图需要依赖 puppeteer (https://www.npmjs.com/package/puppeteer) 模块，请全局安装此模块之后再次尝试',
