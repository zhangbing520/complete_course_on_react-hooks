...
const LOCALE = (0, arco_cli_dev_utils_1.getLocale)();
...
function isValid(filter, filterParams) {
    ...
    for (const key in filter) {
        if (typeof filter[key] === 'boolean' && filter[key] !== filterParams[key]) {
            return false;
        }
 ...
 */
function askQuestion({ type, message, validate, choices, default: _default }, currentInfo) {
...
function collectInfo({ questions = DEFAULT_QUESTION_LIST, baseInfo, }) {
    return __awaiter(this, void 0, void 0, function* () {
