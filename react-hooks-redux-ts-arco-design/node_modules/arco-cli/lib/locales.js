...
function printLocale() {
    const { locale: currentLocale } = (0, arco_cli_dev_utils_1.getGlobalInfo)();
    arco_cli_dev_utils_1.print.info(`${locale_1.default.PREFIX_CURRENT_LOCALE}: ${currentLocale === 'zh-CN'
...
function switchLocale() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, arco_cli_dev_utils_1.writeGlobalInfo)({ locale: nextLocale });
    });
}
