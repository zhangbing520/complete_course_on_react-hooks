...
exports.default = {
    ...
    TIP_GENERATE_FROM_CURRENT_PACKAGE: 'Execute commands directly from the current directory, not the Git root directory',
    TIP_SYNC_SCREENSHOT: 'Automatically generate a screenshot cover, you can specify a local image path for use',
    TIP_SYNC_FROM_CURRENT_PACKAGE: 'Execute commands directly from the current directory, not the Git root directory',
    ...
    TIP_SHOW_HELP: 'If you need to view a subcommand, you can use -h with it, such as: [arco sync -h]',
    ...
    TIP_NOT_MEMBER_OF_GROUP: 'You are not a member of this group, please contact the group owner to add you as a member and then operate again',
    TIP_LINK_THE_ONLY_GROUP_JOINED: 'Whether to link to group 「$groupName」?',
    TIP_LINK_GROUP_SUCCESS: 'Successfully linked to 「$groupName」, you can unlink it via [arco group --link 0]',
    TIP_UNLINK_GROUP_SUCCESS: 'Successfully unlinked',
    TIP_LINK_GROUP_AFTER_LOGIN: 'Link to the joined group 「$groupName」?\n(The materials will be released to the linked group first, you can also skip this step temporarily and use [arco group --link yourGroupId] to manually link)',
